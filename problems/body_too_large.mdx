...
description: "HTTP 413 on POST /v1/runs: the request body is over 4 MiB. What counts toward the cap, how to shrink the body, and what other routes return."
icon: "weight-hanging"
keywords: ["body_too_large", "413", "payload too large", "4 MiB", "body size", "POST /v1/runs", "POST /v1/router/select"]
---
