---
title: "provider_rate_limited"
description: "HTTP 503 on POST /v1/runs: the model service was rate-limiting OpenType on every route tried. Not a limit on your account. Retry with backoff."
icon: "hourglass-half"
keywords: ["provider_rate_limited", "503", "rate limited", "provider", "model service", "backoff", "POST /v1/runs"]
---
