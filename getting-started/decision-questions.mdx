...
| `deadline_ms` | no | Default 30,000, clamped to 1 to 120,000. |
...
- **Total input.** The state and questions together must fit the 3,968-token context of Neon 1.1, else `413` [`input_too_large`](/problems/input_too_large). See [Models and pricing](/getting-started/models-and-pricing#context-window).
