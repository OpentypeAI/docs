...
<Steps>
  <Step title="Open the sign-up page">
    Go to [console.opentype.dev/sign-in](https://console.opentype.dev/sign-in), choose **Continue to sign in**, and create a new account on the next screen.
  </Step>
  <Step title="Fill in the form">
    ...
    | **Work email** | The address you want to sign in with. The free credit is tied to it. |
