...
| Body | JSON with `Content-Type: application/json`, snake_case field names, at most 4 MiB for runs and router selections, 1 MiB elsewhere. Unknown fields are refused. |
