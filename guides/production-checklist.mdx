...
- [ ] **Your HTTP client timeout is longer than `deadline_ms`.** `POST /v1/runs` answers only when the run has settled. Use at least 160 seconds, 10 seconds over the longest deadline; the official SDKs default to that.
