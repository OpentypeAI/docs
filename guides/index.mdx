...
<CardGroup cols={2}>
  ...
  <Card title="SDKs and integrations" icon="puzzle-piece" href="/guides/sdks-and-integrations">
    The TypeScript and Python SDKs, the MCP server and the Claude Code plugin.
  </Card>
</CardGroup>
