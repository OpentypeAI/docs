...
In the example, two settled runs cost 38 micros and one run in flight holds its 5,000-micro ceiling.
...
`ceiling_micros` is the most this run was allowed to spend, at most 5,000. `attempts` has the same fields as a ledger entry.
