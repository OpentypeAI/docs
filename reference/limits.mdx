...
Set your HTTP client timeout to at least **160 seconds**, above the longest deadline, so the server rather than your client ends a slow run and you receive the `504 deadline_exceeded` with its `request_id`. The official SDKs default to 160 seconds.
