...
- **1 MiB body cap.** A body over 1,048,576 bytes is refused before it is read. `POST /v1/runs` answers `413 body_too_large`; other routes answer a plain-text 413.
...
| 5,000 | $0.005, the per-request spend ceiling |
| 1,000,000 | $1 |
